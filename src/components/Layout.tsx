...
const icons: Record<string, React.ReactNode> = {
  ...
  credit: <path d="M3 8h15M8 12H5m9 10H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v10M9 5h6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  tax: <path d="M7 4.5A4.5 4.5 0 1 0 7 13.5 4.5 4.5 0 0 0 7 4.5Zm10 6A4 4 0 1 1 17 18.5m-10 0 10-13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  pool: <path d="M2 8c2 2 4 2 6 0s4-2 6 0 4 2 6 0M2 16c2 2 4 2 6 0s4-2 6 0 4 2 6 0" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  megaphone: <path d="M3 10v2a4 4 0 0 0 4 4h1l4 4V6l-4-4H7a4 4 0 0 0-4 4ZM16 8h5m-4 4h4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  sla: <path d="M3 6l9-3 9 3M4 6v12s8 3 8 3 8-3 8-3V6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  webhook: <path d="M6 4a2 2 0 0 1 2 2 2 2 0 0 1-2 2 2 2 0 0 1-2-2 2 2 0 0 1 2-2Zm12 8a2 2 0 0 1 2 2 2 2 0 0 1-2 2 2 2 0 0 1-2-2 2 2 0 0 1 2-2ZM6 8v4a4 4 0 0 0 4 4h4M18 12V8a4 4 0 0 0-4-4h-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  key: <path d="M21 2l-2 3 1 1-2 2 1 1-2 2-4-4m1-3a4 4 0 1 0-6.4 3.2L11 13a4 4 0 1 0 0-6Z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  warehouse: <path d="M3 9h18M3 15h18M3 21h18M9 9L9 21M15 9v12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  refund: <path d="M9 14L4 9l5-5M4 9h11a5 5 0 0 1 0 10h-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  recurring: <path d="M3 12a9 9 0 0 1 15.5-6.2M21 12a9 9 0 0 1-15.5 6.2M18.5 2.8l.2 3-3 .4M5.5 21.2l-.2-3 3-.4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  proration: <path d="M12 3v18M6 8l6-5 6 5M6 16h12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  ledger: <path d="M5 3h11l3 3v15H5V3Zm4 8h6m-6 4h6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  pricing: <path d="M4 4h16v16H4V4Zm0 5h4m8 0h4M8 4v5M16 4v5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  currency: <path d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm-3-15h5l-4 4 4 4-5 4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  'sla-meter': <path d="M4 14a8 8 0 1 1 16 0M12 14l4-4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />,
  kb: <path d="M5 3h14v18l-7-3-7 3V3Z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />,
  macro: <path d="M8 3h8v6H8V3Zm0 12h8v6H8v-6Z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />,
  score: <path d="M4 7l4 4 6-6 6 6 4-4M4 21h16M12 12v9" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
  escalate: <path d="M12 21V9m0 0-5 5m5-5 5 5M5 3h14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />,
}
...
const nav: { to: string; label: string; icon: string; section?: string }[] = [
  ...
  { to: '/credit-notes', label: 'Credit Notes', icon: 'credit' },
  { to: '/refunds', label: 'Refunds', icon: 'refund' },
  { to: '/taxes', label: 'Tax Rules', icon: 'tax' },
  { to: '/recurring', label: 'Recurring Billing', icon: 'recurring' },
  { to: '/proration', label: 'Proration', icon: 'proration' },
  { to: '/deferred-revenue', label: 'Deferred Revenue', icon: 'ledger' },
  { to: '/expenses', label: 'Expenses', icon: 'expenses' },
  { to: '/promos', label: 'Promos & Offers', icon: 'promos' },
  { to: '/pricing-calendar', label: 'Pricing Calendar', icon: 'pricing' },
  { to: '/currencies', label: 'Currencies', icon: 'currency' },
  ...
  { to: '/router-sla', label: 'Router SLA', icon: 'sla-meter' },
  { to: '/radius', label: 'RADIUS', icon: 'radius' },
  { to: '/devices', label: 'Devices & Binding', icon: 'devices' },
  { to: '/ip-pools', label: 'IP Pools', icon: 'pool' },
  ...
  { to: '/knowledge-base', label: 'Knowledge Base', icon: 'kb' },
  { to: '/macros', label: 'Ticket Macros', icon: 'macro' },
  { to: '/inventory', label: 'Inventory', icon: 'inventory', section: 'Administration' },
  { to: '/field-jobs', label: 'Field Jobs', icon: 'jobs' },
  { to: '/scoreboard', label: 'Tech Scoreboard', icon: 'score' },
  { to: '/sla', label: 'SLA Policies', icon: 'sla' },
  { to: '/escalations', label: 'Escalations', icon: 'escalate' },
  { to: '/users', label: 'Staff & Roles', icon: 'users' },
  { to: '/webhooks', label: 'Webhooks', icon: 'webhook' },
  { to: '/api-keys', label: 'API Keys', icon: 'key' },
  { to: '/warehouse', label: 'Data Warehouse', icon: 'warehouse' },
